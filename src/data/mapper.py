...
class DrugLoader:
    ...
    """
    def __init__(self, drugs_dir: Union[str, Path] = PROJECT_ROOT / "library" / "drugs"):
    ...
    def get_drug_data(self, drug_name: str) -> Data:
        ...
        """
        return self.cache.get(drug_name, Data(x=torch.zeros((1, 5)), edge_index=torch.empty((2, 0), dtype=torch.long)))
...
def map_drugs_to_data(df: pd.DataFrame, drug_col: str, drug_graphs_dir: Union[str, Path]) -> Dict[str, Data]:
    """
