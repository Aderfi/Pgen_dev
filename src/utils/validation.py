...
class ConfigValidator:
    ...
    @staticmethod
    def validate_model_config(config: Dict[str, Any], model_name: str) -> bool:
    ...
    @staticmethod
    def validate_paths_config(paths: Dict[str, Any], create_missing: bool = True) -> bool:
    ...
    @staticmethod
    def validate_optuna_params(params: Dict[str, Any]) -> bool:
