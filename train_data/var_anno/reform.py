...
df_cleaned["effect_function"] = df_cleaned["functional terms"].str.cat(
    df_cleaned[["pd/pk terms", "side effect/efficacy/other"]], sep="", na_rep=""
)

df_cleaned["phenotype_product"] = df_cleaned["gene/gene product"].str.cat(
    df_cleaned["phenotype"], sep="", na_rep=""
)
